...
Today, bluei can intentionally route large structural findings away from the generic autofix loop, but it still lacks the machinery to execute those refactors with strong guarantees.
