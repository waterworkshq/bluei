#!/usr/bin/env python3
"""Daily summary generator for bluei.

Reads current bluei state/run artifacts and produces a daily summary
markdown report.
...
def build_summary_markdown(repo_name: str, date_str: str) -> str:
    ...
    lines = [
        ...
        f"| Open PRs | {open_prs} |",
        f"| Specks Tracked | {findings_entries} |",
        "",
        "## Today's Activity",
        "",
        "| Metric | Count |",
        ...
        f"| Specks Detected | {total_findings} |",
        "",
    ]
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate bluei daily summary")
