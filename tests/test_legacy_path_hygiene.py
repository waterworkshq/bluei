...
def test_no_pr_automation_imports_in_bluei_package():
    """Verify bluei package does not import from pr-automation."""
    bluei_dir = PROJECT_ROOT / "bluei"

    for py_file in bluei_dir.rglob("*.py"):
