...
class TestLLMFixableRulesConfig:
    ...
    def test_loads_rules_from_yaml(self):
        from bluei.engine.constants import load_llm_fixable_rules
    ...
    def test_yaml_file_exists(self):
        ...
        assert yaml_path.exists(), f"llm_fixable_rules.yaml not found at {yaml_path}"
...
class TestNeedsHumanNotFixableStatus:
    ...
    def test_status_is_non_actionable(self):
        from bluei.engine.state import NON_ACTIONABLE_ISSUE_STATUSES

        assert "needs-human-not-fixable" in NON_ACTIONABLE_ISSUE_STATUSES

    def test_count_actionable_excludes_not_fixable(self):
        from bluei.engine.state import count_actionable_issues
...
class TestPrCycleFilterRouting:
    ...
    def _make_issue(
        self, issue_id="QA-0001", status="open", rule="ruff-b904", safe_to_autofix=False
    ):
    ...
    def test_llm_fixable_rules_do_not_overlap_with_claude_required(self):
        ...
        from bluei.engine.constants import load_llm_fixable_rules, CLAUDE_REQUIRED_RULES
    ...
    def test_llm_fixable_rules_do_not_overlap_with_autofix_rules(self):
        ...
        for rule_name in llm_rules:
            ...
            assert (
                rule_name in ("ruff-b904", "ruff-s311") or True
