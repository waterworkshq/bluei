...
def generate_report_html(data: Dict[str, Any],
    ...
    Args:
        ...
        template_path: Path to the dashboard template HTML file.
                       Defaults to blenny_report_template.html in the blenny dir.
    ...
    if template_path is None:
        ...
        template_path = script_dir / 'blenny_report_template.html'
    else:
...
""" + trend_rows + """
  ...
  <div class="footer">
    Generated by <strong>Blenny QA Agent</strong> · Blenny Report Dashboard
  </div>
</div>
</body>
</html>"""
